...
public record DeliveryRouteMappings(List<RouteEntry> routes) {
    public record RouteEntry(String npc, String location, String roomId, List<Integer> target, String npcOverride) {}
    public record RouteTarget(String roomId) {}
    public record RoutePlan(RouteTarget target, String npcOverride) {}
